...
class ExamPaperResource extends Resource
{
    ...
    public static function getEloquentQuery(): Builder
    {
        ...
        return $query->select('id', 'ref_number', 'exam_category_id', 'year', 'month', 'image', 'question', 'option_a', 'option_b','option_c','option_d','correct_answer', 'user_id','created_at','updated_at')
            ->groupBy('ref_number')
            ...
            ->columns([
                ...
                Tables\Columns\TextColumn::make('year')
                    ...
                    ->formatStateUsing(function ($record){
                        return ExamPaper::where('ref_number', $record->ref_number)->count() ?? 0;
                    })
                    ->searchable()->sortable(),
